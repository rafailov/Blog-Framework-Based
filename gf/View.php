...
class View
{
	...
	public function appendToLayout($key, $template){
		if ($key && $template) {
			...
			throw new \Exception("Layout ruqire valid key and template", 500);
	...
	public function _includeFile($file){
		...
		$___fl = $this->___viewDir . str_replace('.', DIRECTORY_SEPARATOR, $file) . $this->___extenxion;
